...
<div id='container'>
	<div id='wrapper'>
        	...
        	<div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      	<ul class="nav navbar-nav">
					    ...
					    <li class="active"><a href="/blogs/index">Your Wall</a></li>
		...
		<div id='body'>
			<h3><?php echo $userinfo["first_name"]; ?>'s Wall</h3>
			<div id="post">
	            ...
	            <form action="/blogs/add_post" method="post">
	                ...
	                <div id='blog_id'>
		                <select class="form-control" name="blog_id">
		                	<?php
		                		if(empty($blogs)){
		                			$this->session->set_flashdata('wall_blog','fail');
		                			redirect("/administration/add_blog");
		                		}
		            ...
		            <div id='post_submit' class='clearfix'>
                ...
                <?php
                    if(!is_null($posts)){
                        foreach ($posts as $post) {
                            echo "<div class='posts clearfix'><span class='name'>" . $post['first_name'] . " " . $post['last_name'] . "</span> - <span class='date'>" . date('F jS\, Y g\:i', strtotime($post['created_on'])) . "</span><span class='blog pull-right'>Posted to Blog: " . $post['name'] . "</span>";
