...
<div id='container'>
	<div id='wrapper'>
		...
		<div id='body'>
			<h3>Delete User's Administrative Privilege - <?php echo $user["first_name"] . " " . $user["last_name"] . " #" . $user["id"] ?></h3>
			<div id='removal'>
				<form role="form" action='/administration/delete_user' method='post'>
				  	<fieldset>
					    <legend><h2>Remove this user?</h2></legend>
					    ...
					    <input type="submit" class="btn btn-danger pull-right" value='Delete User'>
				 	</fieldset>
				</form>
			</div>
